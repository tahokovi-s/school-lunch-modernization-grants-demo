...
Ahead of the STAX Lab training session, please take 20-30 minutes to set up the tools used in the live demo. You do not need to create a project folder yet. The project workflow will be created and opened during the session.
