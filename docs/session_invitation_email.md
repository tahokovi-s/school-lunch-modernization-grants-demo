...
## Optional Extra Resources: Codex Skills

You do not need to install skills before Thursday. If there is time after the core research workflow, the session may use `/skills`, `$skill-installer`, and the official OpenAI skills catalog:

```text
https://github.com/openai/skills
```

The optional workshop skills are:
