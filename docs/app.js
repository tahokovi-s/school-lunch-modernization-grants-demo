const modules = [
  ...
  },
  {
    ...
    body: [
      ...
      "The point is not to make a final journal figure in one try. The point is to show that specific visualization prompts can get you a serious first draft: grant timing, meal outcomes, survey outcomes, and causal-estimate caveats as a coherent SVG gallery."
    ],
    ...
    substeps: [
      ...
      },
      {
        ...
        text: "Use a single ambitious prompt to have Codex install the required visualization packages, write reusable plotting code, produce four SVG drafts, and show the plots as chat artifacts for side-by-side review.",
        prompts: [
          {
            label: "Prompt to copy",
